...
questions: [  
  ...
  { id: 4, type: "paragraph", text: "There was some controversy over confining target groups of blockbuster.", answer: "B" },  { id: 5, type: "input", text: "Instead of being visitors, people turned out to be .", answer: "customers" },
{ id: 6, type: "input", text: "Business nous and ____ were essential requirements.", answer: "public relation skills" },
{ id: 7, type: "input", text: " has contributed to the linking of museums and tourism.", answer: "museology" },
{ id: 8, type: "input", text: "Museums are considered mainly as ____.", answer: "tourist attractions" },
...
type: "multi-group",
limit: 2,
instruction: "Questions 9–10: Choose TWO letters A–E.",
questions: [
{
id: 9,
...
C: "To mix culture and commerce",
D: "To benefit local business",
E: "To benefit directors"
},
answer: ["A", "D"]
},
{
id: 10,
text: "Which TWO cost-related statements are true?",
options: {
A: "High capital expenditure is required",
B: "Staff costs are insignificant",
C: "Organisation is simple",
D: "Human resource costs exist",
E: "Competition is irrelevant"
},
answer: ["A", "D"]
}
]
...
type: "multi-group",
limit: 3,
instruction: "Questions 11–13: Choose THREE letters A–F.",
questions: [
{
id: 11,
text: "Which THREE disadvantages are mentioned?",
options: {
A: "People hesitate to attend exhibitions",
B: "Staff become exhausted",
C: "Pressure from the market place",
D: "Excessive profit",
...
{
id: 12,
text: "Which THREE positive effects are mentioned?",
options: {
A: "Raising museum profile",
B: "Reducing costs",
C: "Supporting local economy",
D: "Decreasing staff workload",
...
{
id: 13,
text: "Which THREE conclusions are drawn?",
options: {
A: "A balance between exhibitions is needed",
B: "Blockbusters should be abandoned",
C: "Profit should be the only goal",
D: "Community needs should be considered",
E: "Museums no longer matter",
F: "Touring exhibitions overseas is considered"
},
answer: ["A", "D", "F"]
}
]

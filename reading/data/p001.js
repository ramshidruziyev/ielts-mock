...
window.readingData = {
  ...
  passage: `
    ...
    <p><b>F.</b> Blockbusters require large capital expenditure, and draw on resources across all branches of an organization; however, the costs don’t end there. There is a Human Resource Management cost in addition to a measurable “real” dollar cost. Everyone from a general laborer to administration staff are required to perform additional tasks. Furthermore, increasing competition may reduce the likelihood that blockbusters will continue to provide surplus revenue.</p>

    <p><b>G.</b> Unfortunately, when the bottom-line is the most important objective to the mounting of blockbuster exhibitions, this same objective can be hard to maintain. Creating, mounting or hiring blockbusters is exhausting for staff, and the real costs throughout an institution are difficult to calculate. Blockbusters expose staff to the pressures of the market place and may lead to creative excellence.</p>
  ...
  questions: `
    ...
    <input type="text" placeholder="A–G" />
    ...
    <label><input type="checkbox" /> C. Presenting the mixture of culture and commerce</label><br>
    ...
    <label><input type="checkbox" /> B. Workers have become tired of workloads</label><br>

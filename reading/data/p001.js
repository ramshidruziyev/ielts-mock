...
window.readingData = {
  ...
  passage: `
<h2>Passage 1: Museum Blockbuster</h2>
...
<p><b>D.</b> The new museology has resulted in the convergence of museums, the heritage industry, and tourism, profit-making and pleasure-giving. This has given rise to much debate about the appropriateness of adapting the activities of institutions so that they more closely reflect the priorities of the market place and whether it is appropriate to see museums primarily as tourist attractions. At many institutions you can now hold office functions in the display areas, or have dinner with the dinosaurs. Whatever commentators may think, managers of museums, art galleries and science centers worldwide are looking for artful ways to blend culture and commerce, and blockbuster exhibitions are at the top of the list.</p>

<p><b>E.</b> But do blockbusters held in public institutions really create a surplus to fund other activities? If the bottom line is profit, then according to the accounting records of many major museums and galleries, blockbusters do make money. For some museums overseas, it may be the money that they need to update parts of their collections or to repair buildings that are in need of attention. For others in Australia, it may be the opportunity to illustrate that they are attempting to pay their way, by recovering part of their operating costs, or funding other operating activities with off-budget revenue.</p>

<p><b>F.</b> Blockbusters require large capital expenditure, and draw on resources across all branches of an organization; however, the costs don’t end there. There is a Human Resource Management cost in addition to a measurable “real” dollar cost. Everyone from a general laborer to a building servicing unit, the front of house, technical, promotion education and administration staff, are required to perform additional tasks. Furthermore, as an increasing number of institutions try to increase visitor numbers, it may be less likely that blockbusters will continue to provide a surplus due to competition.</p>

<p><b>G.</b> Unfortunately, when the bottom-line is the most important objective to the mounting of blockbuster exhibitions, this same objective can be hard to maintain. Creating, mounting or hiring blockbusters is exhausting for staff, with the real costs throughout an institution difficult to calculate.</p>

<p><b>H.</b> Perhaps the best pathway to take is one that balances both blockbusters and regular exhibitions.</p>
`,

  questions: `
<h3>Questions 1–4</h3>
<p>Which paragraph contains the following information? Write the correct letter A–G.</p>

<p>1. A reason for changing the exhibition programs.</p>
<input type="text" />

<p>2. The time people have to wait in a queue in order to enjoy exhibitions.</p>
<input type="text" />

<p>3. Terms people used when referring to blockbuster.</p>
<input type="text" />

<p>4. There was some controversy over confining target groups of blockbuster.</p>
<input type="text" />

<h3>Questions 5–8</h3>
<p>Complete the summary using NO MORE THAN THREE WORDS from the passage.</p>

<p>5. Instead of being visitors, people turned out to be ____.</p>
<input type="text" />

<p>6. Business nous and ____ were essential requirements.</p>
<input type="text" />

<p>7. ____ has contributed to the linking of museums and tourism.</p>
<input type="text" />

<p>8. Museums are considered mainly as ____.</p>
<input type="text" />

<h3>Questions 9–10</h3>
<p>Choose TWO letters A–E.</p>

<label><input type="checkbox" /> A. To offer sufficient money to repair architectures</label><br>
<label><input type="checkbox" /> B. To maintain and increase visitor levels</label><br>
<label><input type="checkbox" /> C. Presenting the mixture in the culture and commerce</label><br>
<label><input type="checkbox" /> D. Being beneficial for the development of local business</label><br>
<label><input type="checkbox" /> E. Being beneficial for the directors</label>

<h3>Questions 11–13</h3>
<p>Choose THREE letters A–F.</p>

<label><input type="checkbox" /> A. People felt hesitated to choose exhibitions</label><br>
<label><input type="checkbox" /> B. Workers has become tired of workloads</label><br>
<label><input type="checkbox" /> C. The content has become more entertaining rather than cultural</label><br>
<label><input type="checkbox" /> D. General laborers are required to perform additional tasks</label><br>
<label><input type="checkbox" /> E. Huge amounts of capital invested in specialists</label><br>
